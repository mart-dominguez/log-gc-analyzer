...
public class Reporte {
    ...
    public void addYoung(Double y){
        this.young=y;
        ++cantidadYoung;
    }
    
    public void addOld(Double y){
        this.old=y;
        ++cantidadOld;
    }
    ...
    public String toString(){
        return this.getClave()+";"+this.dia+";"+this.hora+";"+this.cantidadYoung+";"+this.young+";"+this.cantidadOld+";"+this.old+"\n";
    }
}
